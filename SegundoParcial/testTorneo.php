...
$objTorneo = new Torneo([], 1000.000);

$objPartidoBasquet1 = new PartidoBasquet(7, 11, 2024-05-05, $objE1, 80, $objE2, 120, 0 );
$objPartidoBasquet2 = new PartidoBasquet(8, 12, 2024-05-06, $objE1, 81, $objE2, 110, 0 );
$objPartidoBasquet3 = new PartidoBasquet(9, 13, 2024-05-07, $objE1, 115, $objE2, 85, 0 );
